...
**[Download v1.0.2.0 — RevJMoneyJukebox-1.0.2.0-sideload.zip](https://github.com/revjmoney/RevJMoneysXBOXDevJukebox/releases/latest/download/RevJMoneyJukebox-1.0.2.0-sideload.zip)**
...
| Visualizer | NS-EEL superscope interpreter + oscilloscope + FFT bars, editable trails/colors |
...
| R3 (stick click) | Remove selected track |
| D-pad ←/→ | Switch visualizer mode |
| Triggers | Seek ±10s |
| View | Options (mode, preset, RGB color, trails, points, fade tint) |
| Menu | File browser (USB + Music library) |

## Sideload instructions

1. Put your Xbox into **Developer Mode** and sign in with a user on the console.
2. Unzip `RevJMoneyJukebox-1.0.2.0-sideload.zip`.
